...
public class Populator implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        Star bibb = new Star("Leslie", "Bibb", "", "");
        Star toub = new Star("Shaun", "Toub", "", "");
        Star tahir = new Star("Faran", "Tahir", "", "");
        Star smitrovich = new Star("Bill", "Smitrovich", "", "");
        Star badreya = new Star("Sayed", "Badreya", "", "");
        Star billingsley = new Star("Peter", "Billingsley", "", "");
        Star guinee = new Star("Tim", "Guinee", "", "");
        Star roth = new Star("Tim", "Roth", "", "");
        Star nelson = new Star("Tim Blake", "Nelson", "", "");
        Star burrell = new Star("Ty", "Burrell", "", "");
        Star ferrigno = new Star("Lou", "Ferrigno", "", "");
        Star lee = new Star("Stan", "Lee", "", "");
        Star rockwell = new Star("Sam", "Rockwell", "", "");
        Star slattery = new Star("John", "Slattery", "", "");
        Star shandling = new Star("Gary", "Shandling", "", "");
        Star feore = new Star("Colm", "Feore", "", "");
        Star stevenson = new Star("Ray", "Stevenson", "", "");
        Star asano = new Star("Tadanobu", "Asano", "", "");
        Star dallas = new Star("Josh", "Dallas", "", "");
        Star alexander = new Star("Jaimie", "Alexander", "", "");
        Star cooper2 = new Star("Dominic", "Cooper", "", "");
        Star armitage = new Star("Richard", "Armitage", "", "");
        Star tucci = new Star("Stanley", "Tucci", "", "");
        Star jones2 = new Star("Tobey", "Jones", "", "");
        Star mcdonough = new Star("Neal", "McDonough", "", "");
        Star luke = new Star("Derek", "Luke", "", "");
        Star choi = new Star("Kenneth", "Choi", "", "");
        Star hall = new Star("Rebecca", "Hall", "", "");
        Star dale = new Star("James", "Badge Dale", "", "");
        Star eccleston = new Star("Christopher", "Eccleston", "", "");
        Star levi = new Star("Zachary", "Levi", "", "");
        Star russo2 = new Star("Rene", "Russo", "", "");
        Star redford = new Star("Robert", "Redford", "", "");
        Star grillo = new Star("Frank", "Grillo", "", "");
        Star vancamp = new Star("Emily", "VanCamp", "", "");
        Star hernandez = new Star("Maximiliano", "Hernandez", "", "");
        Star rooker = new Star("Michael", "Rooker", "", "");
        Star close = new Star("Glenn", "Close", "", "");
        Star toro = new Star("Benicio", "Del Toro", "", "");
        Star haddock = new Star("Laura", "Haddock", "", "");
        Star gunn2 = new Star("Sean", "Gunn", "", "");
        Star johnson = new Star("Aaron", "Taylor-Johnson", "", "");
        Star cardellini = new Star("Linda", "Cardellini", "", "");
        Star serkis = new Star("Andy", "Serkis", "", "");
        Star cannavale = new Star("Bobby", "Cannavale", "", "");
        Star greer = new Star("Judy", "Greer", "", "");
        Star fortson = new Star("Abby", "Ryder Fortson", "", "");
        Star bruhl = new Star("Daniel", "Bruhl", "", "");
        Star kani = new Star("John", "Kani", "", "");
        Star davis = new Star("Hope", "Davis", "", "");
        Star klementieff = new Star("Pom", "Klementieff", "", "");
        Star stallone = new Star("Sylvester", "Stallone", "", "");
        Star debicki = new Star("Colm", "Feore", "", "");
